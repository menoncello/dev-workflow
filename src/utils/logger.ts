...
import { redactSensitiveData } from "./errors";
...
export class Logger {
  ...
  private log(
    ...
    // In development or undefined environment, log to console
  ...
  private consoleLog(entry: LogEntry): void {
    ...
    const safeContext = entry.context ? redactSensitiveData(entry.context) : {};
