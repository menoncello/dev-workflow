...
<workflow>
  ...
  <step n="7.5" goal="Validate code examples quality">
    <action>Validate all code examples in story meet quality standards:</action>
    <check>Check TypeScript types in all code examples</check>
    <check>Validate Biome compliance in code examples</check>
    <check>Verify code examples are properly formatted</check>
    <check>Ensure examples use project conventions (naming, patterns)</check>
    <action>Fix any quality violations in code examples</action>
  </step>
