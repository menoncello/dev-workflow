...
{{result_story_list}}
  ...
  <step n="5.5" goal="Verify quality gates compliance">
    <action>Scan changed files for quality violations:</action>
    ...
    <check>Verify Biome linting and formatting was run with 0 errors</check>
