...
<workflow>
  ...
  <step n="4" goal="Run quality gates and validations">
    ...
    <substep n="4.1" goal="TypeScript type checking">
      <action>Run: bun run typecheck (or bun tsc --noEmit)</action>
    ...
    <substep n="4.2" goal="Biome validation">
      ...
      <check>ZERO Biome errors required - both linting and formatting</check>
    ...
    <substep n="4.3" goal="Test execution">
      ...
      <critical>All tests must pass before marking any task complete</critical>
    </substep>
