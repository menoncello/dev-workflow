...
**Context**: When tests grow beyond 350 lines, they become hard to understand, debug, and maintain. Refactor long tests by extracting setup helpers, splitting scenarios, or using fixtures.
...
- [ ] **< 350 Lines** - Keep tests focused; split large tests or extract setup to fixtures
